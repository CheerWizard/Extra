 ...
 */
package com.cws.extra.math

import com.cws.extra.math.operators.clamp
import com.cws.extra.math.operators.cross
import com.cws.extra.math.operators.dot
import com.cws.extra.math.operators.fract
import com.cws.extra.math.operators.length
import com.cws.extra.math.operators.mix
import com.cws.extra.math.operators.normalize
import com.cws.extra.math.operators.pow
import com.cws.extra.math.operators.reflect
import com.cws.extra.math.operators.smoothstep
...
class LinearAlgebraTests {
    ...
    @Test fun dot_perpendicular() {
        assertNear(0f, dot(Float2(1f, 0f), Float2(0f, 1f)))
    }
    ...
    @Test fun length_float2() {
        assertNear(5f, length(Float2(3f, 4f)))
    }

    @Test fun length_float3() {
        assertNear(sqrt(14f), length(Float3(1f, 2f, 3f)))
    }

    @Test fun length_unit() {
        assertNear(1f, length(Float3(1f, 0f, 0f)))
    }
    ...
    @Test fun mix_float_0() {
        assertNear(1f, mix(1f, 3f, 0f))
    }

    @Test fun mix_float_1() {
        assertNear(3f, mix(1f, 3f, 1f))
    }

    @Test fun mix_float_half() {
        assertNear(2f, mix(1f, 3f, 0.5f))
    }
    ...
    @Test fun smoothstep_edge0() {
        assertNear(0f, smoothstep(0f, 1f, 0f))
    }

    @Test fun smoothstep_edge1() {
        assertNear(1f, smoothstep(0f, 1f, 1f))
    }

    @Test fun smoothstep_half() {
        assertNear(0.5f, smoothstep(0f, 1f, 0.5f))
    }

    @Test fun smoothstep_below() {
        assertNear(0f, smoothstep(0f, 1f, -1f))
    }

    @Test fun smoothstep_above() {
        assertNear(1f, smoothstep(0f, 1f, 2f))
    }
    ...
    @Test fun kotlin_math_sin() {
        assertNear(0f, sin(0f))
    }

    @Test fun kotlin_math_cos() {
        assertNear(1f, cos(0f))
    }

    @Test fun kotlin_math_sqrt() {
        assertNear(2f, sqrt(4f))
    }

    @Test fun kotlin_math_abs() {
        assertNear(3f, abs(-3f))
    }

    @Test fun kotlin_math_floor() {
        assertNear(2f, floor(2.7f))
    }

    @Test fun kotlin_math_ceil() {
        assertNear(3f, ceil(2.1f))
    }

    @Test fun kotlin_math_min() {
        assertNear(1f, min(1f, 2f))
    }

    @Test fun kotlin_math_max() {
        assertNear(2f, max(1f, 2f))
    }
}
