...
val Scene.camera: CameraList get() = components.getComponentList<Camera, CameraList>()

inline fun CameraStorage(componentCount: Int) = CameraStorage(CameraList(componentCount))

data class CameraStorage(
    override val list: CameraList,
) : ComponentStorage {

    override fun <T> has(component: T): Boolean = component as? Camera != null

    override fun <T> add(componentIndex: Int, component: T) {
        val c = component as? Camera ?: return
