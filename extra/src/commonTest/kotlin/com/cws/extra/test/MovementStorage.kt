...
val Scene.movement: MovementList get() = components.getComponentList<Movement, MovementList>()

inline fun MovementStorage(componentCount: Int) = MovementStorage(MovementList(componentCount))

data class MovementStorage(
    override val list: MovementList,
) : ComponentStorage {

    override fun <T> has(component: T): Boolean = component as? Movement != null

    override fun <T> add(componentIndex: Int, component: T) {
        val c = component as? Movement ?: return
