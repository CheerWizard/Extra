...
val Scene.damage: DamageList get() = components.getComponentList<Damage, DamageList>()

inline fun DamageStorage(componentCount: Int) = DamageStorage(DamageList(componentCount))

data class DamageStorage(
    override val list: DamageList,
) : ComponentStorage {

    override fun <T> has(component: T): Boolean = component as? Damage != null

    override fun <T> add(componentIndex: Int, component: T) {
        val c = component as? Damage ?: return
