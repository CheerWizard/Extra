...
val Scene.collision: CollisionList get() = components.getComponentList<Collision, CollisionList>()

inline fun CollisionStorage(componentCount: Int) = CollisionStorage(CollisionList(componentCount))

data class CollisionStorage(
    override val list: CollisionList,
) : ComponentStorage {

    override fun <T> has(component: T): Boolean = component as? Collision != null

    override fun <T> add(componentIndex: Int, component: T) {
        val c = component as? Collision ?: return
