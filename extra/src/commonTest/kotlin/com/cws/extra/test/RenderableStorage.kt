...
val Scene.renderable: RenderableList get() = components.getComponentList<Renderable, RenderableList>()

inline fun RenderableStorage(componentCount: Int) = RenderableStorage(RenderableList(componentCount))

data class RenderableStorage(
    override val list: RenderableList,
) : ComponentStorage {

    override fun <T> has(component: T): Boolean = component as? Renderable != null

    override fun <T> add(componentIndex: Int, component: T) {
        val c = component as? Renderable ?: return
