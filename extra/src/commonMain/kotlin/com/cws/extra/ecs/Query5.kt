...
/**
 * A query for entities that have components of type [T1], [T2], [T3], [T4], and [T5].
 */
class Query5<
    T1, L1 : IExtraList,
    T2, L2 : IExtraList,
...
>(
    ...
    @PublishedApi internal var __version5: Int
    ...
    init {
        ...
        val s5 = ComponentRegistry.getRegistrationIndex(id5)
        p5 = scene.components.getPoolUnsafe(s5)
        c5 = scene.components.storages[s5]!!.list as L5

        dp = when {
            p1.size <= p2.size && p1.size <= p3.size && p1.size <= p4.size && p1.size <= p5.size -> p1
            p2.size <= p3.size && p2.size <= p4.size && p2.size <= p5.size -> p2
            p3.size <= p4.size && p3.size <= p5.size -> p3
            p4.size <= p5.size -> p4
            else -> p5
        }
        __size = dp.size
        ...
        __e5 = p5.entityToComponent.array
        ...
        __version5 = p5.structuralVersion
    }

    @PublishedApi
    internal fun refreshIfNeeded() {
        if (__version1 == p1.structuralVersion && __version2 == p2.structuralVersion && __version3 == p3.structuralVersion && __version4 == p4.structuralVersion && __version5 == p5.structuralVersion) return
        refresh()
    }
    ...
    internal fun ensureIndices(forceRefresh: Boolean = false): IntList {
        ...
        for (i in __size - 1 downTo 0) {
            ...
            val i5 = componentIndex(p5, __e5, entity, i)
            if (i1 != ComponentNull &&
                i2 != ComponentNull &&
                i3 != ComponentNull &&
                i4 != ComponentNull &&
    ...
    fun refresh(): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        __version1 = p1.structuralVersion
        __version2 = p2.structuralVersion
        __version3 = p3.structuralVersion
        __version4 = p4.structuralVersion
    ...
    fun without1(): Query4<T2, L2, T3, L3, T4, L4, T5, L5> = Query4(scene, id2, id3, id4, id5)
    fun without2(): Query4<T1, L1, T3, L3, T4, L4, T5, L5> = Query4(scene, id1, id3, id4, id5)
    fun without3(): Query4<T1, L1, T2, L2, T4, L4, T5, L5> = Query4(scene, id1, id2, id4, id5)
    fun without4(): Query4<T1, L1, T2, L2, T3, L3, T5, L5> = Query4(scene, id1, id2, id3, id5)
    fun without5(): Query4<T1, L1, T2, L2, T3, L3, T4, L4> = Query4(scene, id1, id2, id3, id4)

    inline fun filter(predicate: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Boolean): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        val c1 = c1
        val c2 = c2
        val c3 = c3
        val c4 = c4
        ...
        ensureIndices().filterWith { i ->
            val entity = __entities[i]
            predicate(entity, c1, componentIndex(p1, __e1, entity, i), c2, componentIndex(p2, __e2, entity, i), c3, componentIndex(p3, __e3, entity, i), c4, componentIndex(p4, __e4, entity, i), c5, componentIndex(p5, __e5, entity, i))
        }
        return this
    }
    ...
    inline fun <R : Comparable<R>> sortedBy(
    ...
    ): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        ...
        list.sortWith { iA, iB ->
            ...
            val i5A = componentIndex(p5, __e5, entityA, iA)
            ...
            val i5B = componentIndex(p5, __e5, entityB, iB)

            selector(entityA, c1, i1A, c2, i2A, c3, i3A, c4, i4A, c5, i5A)
                .compareTo(selector(entityB, c1, i1B, c2, i2B, c3, i3B, c4, i4B, c5, i5B))
        }
        return this
    }


    inline fun sortedByInt(crossinline selector: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Int): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        val list = ensureIndices()
        val c1 = c1
        val c2 = c2
        val c3 = c3
        ...
        list.sortByInt { i ->
            ...
            val i4 = componentIndex(p4, __e4, entity, i)
            val i5 = componentIndex(p5, __e5, entity, i)
            selector(entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5)
        }
        return this
    }

    inline fun sortedByLong(crossinline selector: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Long): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        val list = ensureIndices()
        val c1 = c1
        val c2 = c2
        val c3 = c3
    ...
    inline fun sortedByFloat(crossinline selector: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Float): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        val list = ensureIndices()
        val c1 = c1
        val c2 = c2
        val c3 = c3
    ...
    inline fun sortedByDouble(crossinline selector: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Double): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        val list = ensureIndices()
        val c1 = c1
        val c2 = c2
        val c3 = c3
    ...
    fun reverse(): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        val list = ensureIndices()
        var i = 0
        var j = list.size - 1
        while (i < j) {
    ...
    fun take(n: Int): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
    ...
    inline fun first(
        ...
        for (idx in 0 until size) {
            ...
            val i4 = componentIndex(p4, __e4, entity, i)
            val i5 = componentIndex(p5, __e5, entity, i)
            if (i1 != ComponentNull && i2 != ComponentNull && i3 != ComponentNull && i4 != ComponentNull && i5 != ComponentNull) {
                block(entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5)
                break
            }
        }
        return this
    ...
    @PublishedApi
    internal inline fun forEachUnfiltered(block: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Unit): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        val indices = __indices
        val c1 = c1
        val c2 = c2
        val c3 = c3
    ...
    inline fun forEachWhere(
        predicate: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Boolean,
        block: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Unit,
    ): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
        forEach { entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5 ->
            if (predicate(entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5)) {
                block(entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5)
            }
        }
        return this
    ...
    inline fun all(predicate: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> Boolean): Boolean {
        forEach { entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5 ->
            if (!predicate(entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5)) return false
        }
        return true
    }
    ...
    inline fun last(): Int {
        ...
        forEach { entity, _, _, _, _, _, _, _, _, _, _ -> result = entity }
        return result
    }
    ...
    inline fun any(): Boolean {
        ...
        for (idx in 0 until size) {
            ...
            val i4 = componentIndex(p4, __e4, entity, i)
            val i5 = componentIndex(p5, __e5, entity, i)
            if (i1 != ComponentNull && i2 != ComponentNull && i3 != ComponentNull && i4 != ComponentNull && i5 != ComponentNull) return true
        }
        return false
    }
    ...
    inline fun count(): Int {
        var count = 0
        forEach { _, _, _, _, _, _, _, _, _, _, _ -> count++ }
        return count
    }

    /** Finds the entity with the minimum value selected by [selector]. Returns -1 if no matches. */
    inline fun <R : Comparable<R>> minEntity(crossinline selector: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> R): Int {
        var minEntity = -1
        var minValue: R? = null
        forEach { entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5 ->
            val value = selector(entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5)
    ...
    inline fun <R : Comparable<R>> maxEntity(crossinline selector: (entity: Int, c1: L1, i1: Int, c2: L2, i2: Int, c3: L3, i3: Int, c4: L4, i4: Int, c5: L5, i5: Int) -> R): Int {
        var maxEntity = -1
        var maxValue: R? = null
        forEach { entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5 ->
            val value = selector(entity, c1, i1, c2, i2, c3, i3, c4, i4, c5, i5)
    ...
    fun shuffle(): Query5<T1, L1, T2, L2, T3, L3, T4, L4, T5, L5> {
    ...
    fun copyEntitiesTo(destination: IntList, clear: Boolean = true): IntList {
        ...
        forEach { entity, _, _, _, _, _, _, _, _, _, _ -> destination.add(entity) }
        return destination
    }
    ...
    fun copyIndicesTo(destination: IntList, clear: Boolean = true): IntList {
        ...
        forEach { _, _, i1, _, i2, _, i3, _, i4, _, i5 ->
            destination.add(if (dp === p1) i1 else if (dp === p2) i2 else if (dp === p3) i3 else if (dp === p4) i4 else i5)
        }
        return destination
    }
    ...
    fun random(): Int {
        ...
        var seen = 0
        forEach { entity, _, _, _, _, _, _, _, _, _, _ ->
            seen++
    ...
    fun toEntities(): IntList {
        val result = IntList()
        forEach { entity, _, _, _, _, _, _, _, _, _, _ -> result.add(entity) }
        return result
    }
