...
enum class MemoryLayout {
    ...
    STD430, // standard layout for Storage Buffer objects on GPU
}
...
fun Boolean.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun Byte.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun UByte.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun Short.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun UShort.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun Char.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun Int.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun UInt.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun Long.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun ULong.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun Float.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
...
fun Double.Companion.sizeBytes(layout: MemoryLayout) =
    when (layout) {
