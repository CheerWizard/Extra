...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("extra-gen")
                description.set("KSP code generator to Extra library")
                url.set("https://github.com/CheerWizard/Extra")
                ...
                scm {
                    connection.set("scm:git:github.com/CheerWizard/Extra.git")
                    developerConnection.set("scm:git:ssh://github.com/CheerWizard/Extra.git")
                    url.set("https://github.com/CheerWizard/Extra")
                }
            }
        }
